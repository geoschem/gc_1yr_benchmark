...
;        ewl, 27 Jun 2017: Use Model1 instead of Model2 pressure if Do_GCHP
   ...
   for i=0,max_station-1 do begin
      ...
      ;=====================================================================
      name_sonde='data/co.prof.for.gmi/co.prof.'+strtrim(num_station(i),2)+'.0.5'
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name1, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name2, Date=Date, Species='SpeciesConcVV_CO')
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name3, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name4, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name1_3, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name2_3, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name3_3, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO & pressure
      CO       = Get_Species_Geos( name4_3, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO
      CO       = Get_Species_Geos( name1_2, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO
      CO       = Get_Species_Geos( name2_2, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO
      CO       = Get_Species_Geos( name3_2, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      ; Get CO
      CO       = Get_Species_Geos( name4_2, Date=Date, Species='SpeciesConcVV_CO' )
      ...
      highval=240
      xtickname1=[ ' ', ' ',  ' ', ' ',  ' ', ' ',   ' ', ' ',   ' ' ]
      xtickname4=[ ' ', ' ', '60', ' ','120', ' ', '180', ' ', '240' ]

;-----------------------------------------------------------------------------
; Prior to 3/2/17:
; Use highval=240 for all stations. It's not clear why 600 was used for this
; station (mps, 3/2/17)
...
;-----------------------------------------------------------------------------
      ...
      axis, highval, yaxis=1, yticks=9, yrange=[-3,-alog10(200)],$
         ytickv=logpres, ytickname=pres2, /ystyle ,color=1
      ...
      plot, sonde2_p, -alog10(pressure_sonde2_p), xstyle=1,ystyle=5,$
         ...
         xticks=8, min_val=-900, yrange=[-3,-alog10(200)], $
         xrange=[loval,highval],$
         charsize=1.5, xtickname=xtickname1
      ...
      axis, highval, yaxis=1, yticks=n_elements(ytickv)-1, $
         yrange=[-3,-alog10(200)],$
         ytickv=logpres, ytickname=pres2, /ystyle,color=1 

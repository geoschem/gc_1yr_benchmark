; $Id: plot_station_profiles_geos_3_models_2_months_selected_0_5.pro,v 1.2 2008/03/11 17:47:25 bmy Exp $
...
;        ewl, 27 Jun 2017: Use Model1 instead of Model2 pressure if Do_GCHP
   ...
   for i=0,max_station-1 do begin
      ...
      Pressure = Get_Pressure_Geos( name1_P, PTOP=PTOP1, Lat=Lat, Lon=Lon )
      ...
      Pressure = Get_Pressure_Geos( name2_P, PTOP=PTOP1, Lat=Lat, Lon=Lon )
      ...
      ;=====================================================================
      ; Read O3 from first model and 3rd month
      ;===================================================================== 

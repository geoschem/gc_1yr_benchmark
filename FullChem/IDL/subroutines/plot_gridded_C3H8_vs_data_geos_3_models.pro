...
;                          intead of the default 3 versions
   ...
   scales = [200, 200, 200, 200, 200, 200, 250, 100, 1000, 500, 150, $
             100, 250, 200, 200, 200, 400, 200, 100, 100, 100, 100,  $
             100, 100, 200, 300, 100, 250, 500, 250, 250, 50, 50, $
...
;    spawn, cmd
      ...
      oplot, co*1000/3, -alog10(pressure), $
      ...
      oplot, co*1000/3, -alog10(pressure), $
             psym=-sym(1), symsize=0.2, linestyle=3, color=4
      endif
...
;if ncount eq nrow*ncol then begin
      xyouts, 0.05, 0.5, 'Pressure (hPa)', $
              /normal, align=0.5, orientation=90, charsize=1.2, $
              color=!MYCT.BLACK

      xyouts, 0.5, 0.05, 'C3H8 (ppt)', $

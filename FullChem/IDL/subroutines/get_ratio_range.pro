...
;        This will be used to create ratioentration plots for GEOS-Chem 
;        benchmarking.
;
; CATEGORY:
...
;
; REQUIREMENTS:
;        Routine READ_RATIO_RANGE must be called before this routine
...
;
; EXAMPLE:
;        READ_RATIO_RANGE, 'ratio_range.1mon'
;        GET_RATIO_RANGE, 'NOx', THIS_LOBOUND, THIS_HIBOUND, THIS_UNIT
...
pro Get_Ratio_Range, TracerName, This_LoBound, This_HiBound, This_Unit

   ; Common block
   common GCRat, Names, LoBound, HiBound, UnitStr

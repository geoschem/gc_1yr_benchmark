; $Id: plot_4lev_o3_geos_3_models.pro,v 1.2 2008/03/11 17:47:25 bmy Exp $
pro plot_4lev_o3_geos_3_models, pref1, ptop1, dlat1, dlon1, model1, year1, $
...
;        bmy, 11 Jul 2007: Now use CTM_INDEX to pick the model grid box indices

...
;                          intead of the default 3 versions
   ...
   scales = [250, 250, 250, 250, 250, 250, 250, 250, 250, $
             250, 250, 250, 250, 150, 250, 150, $
             350, 250, 250, 500, 350, 350, 350, 500, 500, $
             250, 150, 250, 250, 250, 250, 250, $
             500, 300, 500, 250, 500, 500, 500, 250, 150, $
...
;    spawn, cmd
      ...
      for w=0, Hk-1 do begin
         if gtestd(w) gt 0. then begin
            ...
            xyouts, howfarover, -alog10(tmp(w)), nnum, $
                    charsize=0.6, /data, color=!MYCT.BLACK
            
         endif
      endfor

      ;--------------------------------
      ; -- read data from model #1 --
      ;--------------------------------
      ...
      oplot, co*1000, -alog10(pressure), $
             psym=-sym(1), symsize=0.2, linestyle=1, color=!MYCT.RED

      ;--------------------------------
      ; -- read data from model #2 --
      ;--------------------------------
...
;if ncount eq nrow*ncol then begin
      xyouts, 0.05, 0.5, 'Pressure (hPa)', $
              /normal, align=0.5, orientation=90, $
              charsize=1.2, color=!MYCT.BLACK

      xyouts, 0.5, 0.05, 'NOx (ppt)', $

...
;    spawn, cmd
      ...
      plot, gtemedian(0:Hk-1)/1000, -alog10(tmp), xstyle=1, ystyle=5, $
            ...
            xrange=[loval, highval], charsize=1.2, xmargin=[4, 3], $
            ymargin=[3, 2], color=!MYCT.BLACK
      ...
      oplot, co, -alog10(pressure), $
             psym=-8, symsize=0.2, linestyle=1, color=!MYCT.RED

      ;-----------------------------------
      ; -- plot data from 2nd model --
      ;-----------------------------------
      ...
      oplot, co, -alog10(pressure), $
             psym=-8, symsize=0.2, linestyle=2, color=!MYCT.GREEN

      if ( nVersions eq 3 ) then begin
      ;-----------------------------------
      ; -- plot data from 3rd model --
      ;-----------------------------------
